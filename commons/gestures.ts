...
class Gestures {
     ...
     */
    static async checkIfDisplayedWithSwipeUp (element:WebdriverIO.Element, maxScrolls:number, amount = 0):Promise<void> {
    ...
    static swipeElement (element:WebdriverIO.Element,from: XY, to: XY) {
        element.touchPerform([
            // Press the 'finger' on the first location
            {
                action: 'press',
                options: from,
